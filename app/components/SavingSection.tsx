...
export default function SavingSection() {
  const features: Feature[] = useMemo(
    () => [
      ...
      {
        tag: "Поиск альтернатив",
        title: "Учитываем доставку",
        description:
          "Если конкретно продукта нет в магазине - не проблема, предложим альтернативные варианты",
      ...
      },
      {
        ...
        description:
          "Можете заказать доставку прямо здесь и не надо переходить в другие приложения",
      ...
      },
      {
        ...
        description:
          "Мы поможем не пропустить ни одну акцию и сэкономить ваши деньги",
        imageSrc: "/phoneCartPortrait.png",
